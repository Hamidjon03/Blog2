...
class StoreRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'preview_image.required' => 'Bu joyga rasm yuklanishi kerak, iltimos boshqa rasm yuklang',
            'preview_image.file' => 'Bu joyga fayl yuklanishi kerak, iltimos boshqa rasm yuklang',
            'main_image.required' => 'Bu joyga tasm yuklanishi kerak, iltimos boshqa rasm yuklang',
            'main_image.file' => 'Bu joyga file yuklanishi kerak, iltimos boshqa rasm yuklang',
